                        ...
                        {pendingCount > 0 ? (
                            <>
                                ...
                                <p className="text-sm text-muted-foreground mb-4 max-w-xs">
                                    You have {pendingCount} document{pendingCount > 1 ? 's' : ''} pending verification.
                                    Please wait for approval or upload additional documents.
                                </p>
                            ...
                            <>
                                ...
                                <p className="text-sm text-muted-foreground mb-6 max-w-xs">
                                    Please upload and verify your KYC documents to proceed with the booking.
                                </p>
                            </>
                        )}
