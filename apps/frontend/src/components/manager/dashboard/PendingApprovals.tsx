      ...
      <CardContent className="p-0">
        <div className="divide-y divide-orange-100">
          {isLoading ? (
            ...
            bookings.slice(0, 5).map((booking) => (
              <div
                key={booking.id}
                className="p-4 flex items-center justify-between hover:bg-orange-50/30 transition-colors group"
              >
                ...
                <Button
                  size="sm"
                  className="h-8 bg-white border border-orange-200 hover:bg-orange-50 hover:text-orange-700 hover:border-orange-300 text-neutral-700 shadow-sm"
                  asChild
                >
        ...
        {bookings.length > 0 && (
          <div className="p-3 bg-neutral-50 border-t flex justify-center">
            <Button
              variant="link"
              className="text-xs text-orange-600 h-auto p-0 hover:no-underline hover:text-orange-700 group"
              asChild
            >
