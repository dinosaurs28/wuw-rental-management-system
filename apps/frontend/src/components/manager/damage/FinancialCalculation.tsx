                ...
                <div className="bg-gray-50 p-4 rounded-lg space-y-3">
                    ...
                    <div className="flex justify-between items-center items-end">
                        <div className="space-y-1">
                            <Label htmlFor="finalCost" className="text-red-900 font-semibold ">Final Damage Cost</Label>
                            <p className="text-[10px] text-gray-500">Enter total gathered from review</p>
                        </div>
                    ...
                    <div className={`text-xs font-medium text-center p-1 rounded ${isRefund ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
