...
export const DamageSummary: React.FC<DamageSummaryProps> = ({ damageDetails }) => {
    ...
    return (
        <Card className="h-full border-none shadow-none bg-transparent">
            <div className="mb-4">
                ...
                <p className="text-sm text-gray-500">Review reported damages and manager notes.</p>
            </div>
                    ...
                    <Card key={index} className="overflow-hidden border-l-4 border-l-orange-500">
                        <CardContent className="p-4">
                            <div className="flex justify-between items-start mb-2">
                                ...
                                <Badge variant={damage.severity === 'Major' ? 'destructive' : 'secondary'} className="uppercase text-[10px]">
