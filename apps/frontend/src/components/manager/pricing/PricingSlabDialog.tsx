...
import { type PricingDiscountSlab, pricingService } from '@/services/pricing.service';
...
const formSchema = z.object({
    ...
    multiplier: z.coerce.number().min(0.01).max(1.0, "Multiplier must be between 0.01 and 1.0"),
});
...
export function PricingSlabDialog({ open, onOpenChange, editingSlab }: PricingSlabDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    <DialogTitle>{editingSlab ? 'Edit Discount' : 'Add New Discount'}</DialogTitle>
                </DialogHeader>
