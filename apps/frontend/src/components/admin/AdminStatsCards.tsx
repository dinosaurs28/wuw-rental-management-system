  ...
  const KPICard = ({
    ...
    <Card className="p-6 border border-neutral-200 shadow-sm hover:shadow-md transition-all hover:border-[#FF5F00]/20 bg-white rounded-xl group relative overflow-hidden">
      <div className="flex items-start justify-between relative z-10">
        ...
        <div
          className={`p-3 rounded-xl transition-colors ${bgClass} group-hover:bg-white border border-transparent group-hover:border-neutral-100 group-hover:shadow-sm`}
        >
