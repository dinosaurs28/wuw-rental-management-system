...
import { Edit2, Trash2, Plus, Loader2, Copy, Check } from "lucide-react";
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-neutral-500 mt-1">
            Manage your physical locations and assigned managers.
          </p>
        </div>
          ...
          <Table>
            <TableHeader className="bg-neutral-50/50">
              <TableRow className="hover:bg-transparent border-b-neutral-200">
                <TableHead className="pl-6 h-12 font-medium text-neutral-600 whitespace-nowrap">
                  Name
                </TableHead>
                <TableHead className="font-medium text-neutral-600 whitespace-nowrap">
                  Address
                </TableHead>
                <TableHead className="font-medium text-neutral-600 whitespace-nowrap">
                  Contact
                </TableHead>
                <TableHead className="text-right pr-6 font-medium text-neutral-600 whitespace-nowrap">
                  Actions
                </TableHead>
              </TableRow>
            </TableHeader>
                  ...
                  <TableCell colSpan={4} className="h-[400px] text-center">
                    <div className="flex flex-col items-center justify-center space-y-3">
                      ...
                      <p className="text-neutral-500 max-w-sm mx-auto">
                        Get started by adding your first branch location to the
                        system.
                      </p>
                      <Button
                        variant="outline"
...
function BranchRow({
  ...
  return (
    <TableRow className="hover:bg-orange-50/30 transition-colors border-b-neutral-100 group">
      <TableCell className="font-semibold text-neutral-900 pl-6 py-4 whitespace-nowrap">
        {branch.name}
      </TableCell>
      <TableCell
        className="text-neutral-600 max-w-[200px] sm:max-w-[300px] truncate"
        title={branch.address}
      >
        {branch.address}
      </TableCell>
      <TableCell className="text-neutral-600 font-mono text-sm whitespace-nowrap">
        {branch.phone || "—"}
      </TableCell>
        ...
        <Dialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Are you sure you want to delete <strong>{branch.name}</strong>?
                This action cannot be undone and will affect associated data.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter className="flex-col sm:flex-row gap-2">
              <Button
...
function ManagerCredentialsDialog({
  ...
  return (
    <DialogContent className="sm:max-w-[420px] w-[95vw] rounded-lg">
      <DialogHeader>
        <DialogTitle>Branch Created Successfully</DialogTitle>
        <DialogDescription>
          Share these login credentials with the manager. The password is
      ...
      <DialogFooter>
        <Button
          onClick={onClose}
          className="bg-[#FF5F00] hover:bg-[#E65600] text-white w-full"
        >
          Done
        </Button>
      </DialogFooter>
...
function CreateBranchDialog({
  ...
  const [managerCredentials, setManagerCredentials] =
    useState<ManagerCredentials | null>(null);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsLoading(true);
      const result = await adminService.createBranch(formData);
  ...
  return (
    <DialogContent className="sm:max-w-[500px] w-[95vw] p-0 overflow-hidden gap-0 rounded-lg">
      <div className="p-4 sm:p-6 pb-4 border-b bg-neutral-50/50">
        <DialogHeader className="gap-1 text-left">
          ...
          <DialogDescription className="text-sm">
            Enter the details for the new physical location. A temporary
            password will be generated for the manager.
          </DialogDescription>
        </DialogHeader>
      </div>
      ...
      <form
        ...
        className="p-4 sm:p-6 space-y-4 overflow-y-auto max-h-[70vh]"
      >
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="managerName" className="text-neutral-700">
                Manager Name
              </Label>
              <Input
                id="managerName"
            ...
            <div className="grid gap-2 sm:col-span-2">
              <Label htmlFor="manager" className="text-neutral-700">
                Manager Email
              </Label>
              <Input
                id="manager"
        ...
        <DialogFooter className="mt-8 flex-col-reverse sm:flex-row gap-2">
          ...
          <Button
            type="submit"
            disabled={isLoading}
            className="bg-[#FF5F00] hover:bg-[#E65600] text-white h-12 px-6 w-full sm:w-auto"
          >
...
function EditBranchDialog({
  ...
  const manager =
    branch.users && branch.users.length > 0 ? branch.users[0] : null;
  ...
  return (
    <DialogContent className="sm:max-w-[425px] w-[95vw] rounded-lg">
      ...
      <form
        onSubmit={handleSubmit}
        className="grid gap-4 py-4 overflow-y-auto max-h-[70vh]"
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 items-start sm:items-center gap-2 sm:gap-4">
          <Label htmlFor="edit-address" className="text-left sm:text-right">
            Address
          </Label>
          <Input
            id="edit-address"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 items-start sm:items-center gap-2 sm:gap-4">
          <Label htmlFor="edit-contact" className="text-left sm:text-right">
            Contact
          </Label>
          <Input
            id="edit-contact"
