...
export const getDamageReport = async (damageReportId: string): Promise<DamageReport> => {
    const response = await axios.get<DamageReport>(`/branchManager/damage-reports/${damageReportId}`);
