...
export const adminService = {
  ...
  getBranches: async (): Promise<AdminBranch[]> => {
    const response = await apiClient.get<{ data: AdminBranch[] }>(
  ...
  createBranch: async (
    ...
    const response = await apiClient.post<CreateBranchResponse>(
      "/admin/dashboard/branches/create",
      data,
    );
    return response.data;
  },
  ...
  updateBranch: async (
    ...
    const response = await apiClient.put<{
      message: string;
      data: AdminBranch;
    }>(`/admin/dashboard/branches/edit/${branchId}`, data);
    return response.data.data;
  },

  getBranchDetails: async (
    branchId: string,
  ): Promise<AdminBranch & { managerName: string; managerEmail: string }> => {
    const response = await apiClient.get<{
      message: string;
      data: AdminBranch & { managerName: string; managerEmail: string };
    }>(`/admin/dashboard/branches/${branchId}`);
    return response.data.data;
  },
  ...
  getRevenueReport: async (
    ...
    const response = await apiClient.get<RevenueReportResponse>(
      "/admin/dashboard/reports/revenue",
      { params },
    );
    return response.data;
  },
  ...
  ): Promise<{ message: string; data: RevenueTrendItem[] }> => {
    const response = await apiClient.get(
      "/admin/dashboard/reports/revenue-trends",
      { params },
    );
    return response.data;
  },
  ...
  getRevenueByCategory: async (params: {
    ...
    endDate?: string;
    branchId?: string;
  }): Promise<{ message: string; data: CategoryRevenueItem[] }> => {
    const response = await apiClient.get(
      "/admin/dashboard/reports/revenue-by-category",
      { params },
    );
    return response.data;
  },
  ...
  getKPISummary: async (params: {
    ...
    endDate?: string;
    branchId?: string;
  }): Promise<{ message: string; data: KPISummaryData }> => {
    const response = await apiClient.get(
      "/admin/dashboard/reports/kpi-summary",
      { params },
    );
    return response.data;
  },
  ...
  getPaymentMethodBreakdown: async (params: {
    ...
    endDate?: string;
    branchId?: string;
  }): Promise<{ message: string; data: PaymentMethodItem[] }> => {
    const response = await apiClient.get(
      "/admin/dashboard/reports/payment-methods",
      { params },
    );
    return response.data;
  },
  ...
  ): Promise<VehicleHistoryResponse | Blob> => {
  ...
  getDailySummaryReport: async (params: {
    ...
    const response = await apiClient.get(
      "/admin/dashboard/reports/daily-summary",
      config,
    );
    return response.data;
  },
  ...
  getVehicleAvailabilityReport: async (params: {
    ...
    const response = await apiClient.get(
      "/admin/dashboard/reports/vehicle-availability",
      config,
    );
    return response.data;
  },
  ...
  getInsurancePermitExpiryReport: async (params: {
    ...
    const response = await apiClient.get(
      "/admin/dashboard/reports/insurance-permit-expiry",
      config,
    );
    return response.data;
  },
  ...
  getCollectionReport: async (params: {
    ...
    const response = await apiClient.get(
      "/admin/dashboard/reports/collection",
      config,
    );
    return response.data;
  },
  ...
  getFleetExecutiveReport: async (params: {
    ...
    const response = await apiClient.get(
      "/admin/dashboard/reports/fleet-executive",
      config,
    );
    return response.data;
  },
