            ...
            <main className="container max-w-7xl mx-auto py-6 px-4 md:px-6 space-y-8">
                ...
                >
                    <div className="space-y-1">
                        <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground">Operations Dashboard</h1>
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
                        ...
                        <div className="flex gap-3 w-full sm:w-auto">
                            <Button variant="outline" onClick={() => setIsScannerOpen(true)} className="flex-1 sm:flex-none">
                    ...
                    <div className="flex bg-muted/30 p-1 rounded-lg w-full sm:w-fit overflow-x-auto">
                        <button
                            ...
                            className={cn(
                                ...
                                filter === "PICKUP" ? "bg-white text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"
                            )}
                        >
                            Pickups
                        </button>
                        <button
                            ...
                            className={cn(
                                "flex-1 sm:flex-none px-4 py-1.5 text-sm font-medium rounded-md transition-all whitespace-nowrap",
                                filter === "RETURN" ? "bg-white text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"
                            )}
                        >
                            Returns
                        </button>
