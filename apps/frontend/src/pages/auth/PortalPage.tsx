...
const portalOptions = [
  {
    title: "Administrator",
    description:
      "Global system management, branch creation, and high-level reporting.",
    icon: ShieldCheck,
    link: "/admin/sign-in",
  ...
  },
  {
    ...
    description:
      "Manage branch operations, vehicles, employees, and local revenue.",
    icon: Building2,
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center p-6 md:p-12">
        ...
        >
          ...
          <p className="text-zinc-400 text-lg md:text-xl font-medium leading-relaxed">
            Secure entry points for specialized management and operational
            staff. Choose your portal to begin.
          </p>
        </motion.div>
