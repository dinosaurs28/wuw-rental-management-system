            ...
            <div className="hidden lg:block relative h-full w-full bg-zinc-900 overflow-hidden">
                ...
                <div className="relative z-20 flex h-full flex-col justify-between p-12 text-white">
                    ...
                    <div className="space-y-2">
                        <h1 className="text-4xl font-bold tracking-tight">Master Control.</h1>
                        <p className="text-lg text-zinc-300">Complete oversight of the entire vehicle rental platform.</p>
                    </div>
                </div>
            </div>
