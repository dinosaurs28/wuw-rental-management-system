        ...
        >
            {step === "phone" ? (
                <form onSubmit={handleSendOtp} className="space-y-6">
                    ...
                    <Button type="submit" className="w-full h-12 bg-orange-600 hover:bg-orange-700 text-white font-bold" disabled={isSendPending}>
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-6">
                    <div className="space-y-2 text-center">
                        ...
                        <div className="text-xs text-gray-500 mt-2">
                            Code Sent to {phone}. <button type="button" onClick={() => setStep("phone")} className="text-orange-600 hover:underline">Change number</button>
                        </div>
                    </div>

                    <Button type="submit" className="w-full h-12 bg-orange-600 hover:bg-orange-700 text-white font-bold" disabled={isVerifyPending}>
