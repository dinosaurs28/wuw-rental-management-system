...
function entityBadge(entity: string) {
  return <Badge variant="secondary" className="text-xs font-mono">{entity}</Badge>;
}
          ...
          <>
            ...
            <div className="space-y-4 text-sm">
              ...
              <Section title="Actor">
                ...
                <Row label="ID" value={<code className="text-xs bg-muted px-1.5 py-0.5 rounded">{log.actorPublicId}</code>} />
              </Section>
              {log.metadata && (
                <>
                  <Separator />
    ...
    <ManagerLayout>
      <div className="max-w-[1440px] mx-auto px-4 md:px-6 pt-8 pb-12">
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            <BreadcrumbItem><BreadcrumbLink href="/manager/dashboard">Dashboard</BreadcrumbLink></BreadcrumbItem>
            <BreadcrumbSeparator />
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-neutral-500 mt-1">All actions performed by your branch staff.</p>
          </div>
