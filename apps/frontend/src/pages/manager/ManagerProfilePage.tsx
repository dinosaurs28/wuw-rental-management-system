                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border max-w-2xl">
                    <div className="space-y-4">
                        <div>
                            ...
                            <p className="text-lg font-medium">{user?.name || 'Manager Name'}</p>
                        </div>
                        <div>
                            <label className="text-sm font-medium text-neutral-500">Email</label>
                            <p className="text-lg font-medium">{user?.email || 'manager@example.com'}</p>
                        </div>
                        <div>
                            <label className="text-sm font-medium text-neutral-500">Role</label>
                            <p className="text-lg font-medium">{user?.role || 'Branch Manager'}</p>
                        </div>
                    </div>
                </div>
            </div>
