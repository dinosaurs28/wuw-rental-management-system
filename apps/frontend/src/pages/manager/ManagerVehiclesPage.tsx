...
import { Plus, Search, MoreHorizontal, Fuel, Settings2, AlertTriangle, Coins } from "lucide-react";
            ...
            <div className="max-w-[1440px] mx-auto px-4 md:px-6 pt-8 pb-12">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                    <div>
                        ...
                        <p className="text-neutral-500 mt-1">Manage your fleet, pricing rules, and availability.</p>
                    </div>
                </div>
                        ...
                        {isLoading ? (
                            ...
                            <>
                                        ...
                                        <TableBody>
                                            {filteredVehicles.map((vehicle) => (
                                                <TableRow key={vehicle.publicId}>
                                                    ...
                                                    <TableCell>
                                                        <div>
                                                            <p className="font-medium text-neutral-900">{vehicle.make} {vehicle.model}</p>
                                                            <p className="text-xs text-neutral-500">{vehicle.regNo || "N/A"}</p>
                                                        </div>
                                                    </TableCell>
                                                    <TableCell>
                                                    ...
                                                    <TableCell>
                                                        <DropdownMenu>
                                                            ...
                                                            <DropdownMenuContent align="end">
                                                                ...
                                                                <DropdownMenuSeparator />
                                                                <DropdownMenuItem onClick={() => navigate(`/manager/vehicles/edit/${vehicle.publicId}`)}>
                                                                    Edit Vehicle
                                                                </DropdownMenuItem>
                                ...
                                <div className="md:hidden space-y-4">
                                    {filteredVehicles.map((vehicle) => (
                                        <div key={vehicle.publicId} className="bg-white p-4 rounded-lg border shadow-sm flex gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex justify-between items-start">
                                                    <div>
                                                        <h3 className="font-medium text-neutral-900 truncate">{vehicle.make} {vehicle.model}</h3>
                                                        <p className="text-sm text-neutral-500">{vehicle.category?.name || "N/A"}</p>
                                                    </div>
                                                    <Button variant="ghost" size="icon" className="-mr-2 -mt-2" onClick={() => navigate(`/manager/vehicles/edit/${vehicle.publicId}`)}>
