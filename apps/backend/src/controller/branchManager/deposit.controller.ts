...
import { createDepositRuleSchema,updateDepositRuleSchema } from "@repo/schemas"
    ...
    try {
        ...
        if (existingRule) {
            return res.status(StatusCode.CONFLICT).json({
                message: "A deposit rule already exists for this category. Please edit the existing rule."
            });
        }
