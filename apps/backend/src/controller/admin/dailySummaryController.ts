...
export const GetDailySummary = async (req: Request, res: Response) => {
    try {
        ...
        const collectionsByMethod = depositsData.reduce((acc, deposit) => {
        ...
        const totalCollected = collectionsByMethod.cash + collectionsByMethod.upi + collectionsByMethod.online;
        ...
        const currentUtilization = totalVehicles > 0
        ...
        const bookingsVsYesterday = yesterdayRevenueData._count !== 0
