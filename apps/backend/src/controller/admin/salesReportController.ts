    ...
    try {
        ...
        const formattedBookings = bookings.map(booking => ({
            ...
            financial: {
                ...
                taxableAmount: Number(booking.totalBase) - Number(booking.totalDiscount),
                ...
                amountPaid: booking.paymentStatus === PaymentStatus.SUCCESS
                    ? Number(booking.totalFinal)
                    : 0,
                balanceAmount: booking.paymentStatus === PaymentStatus.SUCCESS
                    ? 0
                    : Number(booking.totalFinal),
            },
            payment: {
