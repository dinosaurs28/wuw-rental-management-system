 ...
 */
export async function transformBookingToInvoiceData(bookingId: number): Promise<InvoiceData> {
    try {
        ...
        const invoiceData: InvoiceData = {
            invoiceNumber: booking.invoice.invoiceNumber || `INV/${new Date().getFullYear()}/${bookingId.toString().padStart(5, '0')}`,
        ...
        console.log(`[Invoice Data Transformer] Successfully transformed booking ${bookingId}`);
